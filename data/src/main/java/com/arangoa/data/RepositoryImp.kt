package com.arangoa.data

import android.util.Log
import com.arangoa.data.extensions.request
import com.arangoa.data.platform.NetworkHandler
import com.arangoa.domain.databasemanager.ILocalDataSource
...
import com.arangoa.domain.databasemanager.repository.MaterialApi
import com.arangoa.domain.databasemanager.repository.MaterialRepository
import com.arangoa.domain.databasemanager.repository.toWordEntityList
import com.arangoa.domain.databasemanager.repository.toWordList
import com.arangoa.domain.databasemanager.repository.toWordsList
...
@Singleton
class LocalRepositoryDataSourceImp @Inject constructor(private val wordDao: WordDao):
    ILocalDataSource {
